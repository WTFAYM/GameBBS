$.fn.extend({
    _opt: {placeholader: "请输入文章正文内容", validHtml: [], limitSize: 3, showServer: !1}, artEditor: function (e) {
        var t = this, a = {
        ...
        try {
            $(t._opt.imgTar).on("change", function (e) {
                ...
                r.readAsDataURL(a), r.onload = function (e) {
                    var r = e.target.result, o = new Image;
        ...
        var t, a = document.createElement("canvas"), r = a.getContext("2d"), o = document.createElement("canvas"), i = o.getContext("2d"), n = (e.src.length, e.width), l = e.height;
        ...
        var t = this, a = t._opt.uploadField || "uploadfile", r = $.extend(t._opt.data, {});
